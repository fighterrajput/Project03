	...
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCT_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				&emsp;
				 <div class="col-sm-2">
					<input type="text" name="expireDate" placeholder="Enter expireDate"
						class="form-control"
						value="<%=ServletUtility.getParameter("expireDate", request)%>">
				</div> 
				<%-- 
					&emsp;
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="20%" class="text">Expire Date</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=DataUtility.getDateString(dto.getExpireDate())%></td>
