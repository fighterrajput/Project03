...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.PRODUCT_DETAILS_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("category", String.valueOf(dto.getCategory()), list1)%></div>
				&emsp;
				&emsp;
				 <div class="col-sm-2">
					<input type="text" name="dateOfPurchase" placeholder="Enter dateOfPurchase"
						class="form-control"
 ...
 --%>				
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=ProductDetailsCtl.OP_SEARCH%>"> &emsp; <input
						type="submit" class="btn btn-dark btn-md" style="font-size: 15px"
						name="operation" value="<%=ProductDetailsCtl.OP_RESET%>">
				</div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="15%" class="text">DateOfPerchased</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="ProductDetailsCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=ProductDetailsCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ProductDetailsCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=ProductDetailsCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=ProductDetailsCtl.OP_NEXT%>"
			...
			<div class="row">
				...
				<div style="padding-left: 48%;">
					<input type="submit" name="operation"
						class="btn btn-primary btn-md" style="font-size: 17px"
						value="<%=ProductDetailsCtl.OP_BACK%>">
				</div>
