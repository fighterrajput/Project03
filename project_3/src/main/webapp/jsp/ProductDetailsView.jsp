...
<body class="hm">
				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Update ProductDetails</h3>
							<%
								} else {
							%>
							<h3 class="text-center default-text text-primary">Add ProductDetails</h3>
							<%
								}
							%>
							<!--Body-->
    ...
    <div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" class="form-control" name="price" placeholder="Price" value="<%=DataUtility.getStringData(dto.getPrice())%>">
      </div>
    </div>
	...
	<span class="pl-sm-5"><b>DateOfPurchase</b>
	<span style="color: red;">*</span></span></br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" id="datepicker2" name="dateOfPurchase" class="form-control" placeholder="dateOfPurchase" readonly="readonly" value="<%=DataUtility.getDateString(dto.getDateOfPurchase()) %>">
      </div>
    </div>	
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <%=HTMLUtility.getList("category", String.valueOf(dto.getCategory()), list)%>
      </div>
    </div>							
	...
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("priority", request)%></font></br>		
					...
					<%
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=ProductDetailsCtl.OP_UPDATE%>"> 
									
									<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=ProductDetailsCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation" class="btn btn-success btn-md" style="font-size: 17px" value="<%=ProductDetailsCtl.OP_SAVE%>"> 
								
								<input type="submit" name="operation" class="btn btn-warning btn-md" style="font-size: 17px" value="<%=ProductDetailsCtl.OP_RESET%>">
							</div>
