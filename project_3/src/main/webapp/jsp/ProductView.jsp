...
<body class="hm">
	...
	<%-- 
     ...
     <span class="pl-sm-5"><b>Type</b><span style="color:red;">*</span></span></br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
 ...
 <font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("type", request)%></font></br>							
	...
	<span class="pl-sm-5"><b>expireDate</b>
	<span style="color: red;">*</span></span></br>
	<div class="col-sm-12">
      <div class="input-group">
        <div class="input-group-prepend">
        ...
        <input type="text" id="datepicker2" name="expireDate" class="form-control" placeholder="expireDate" readonly="readonly" value="<%=DataUtility.getDateString(dto.getExpireDate()) %>">
      </div>
    </div>	
